...
namespace SoulFoodAiBack.Migrations
{
    ...
    [Migration("20260319214953_MakeUserDataNullable")]
    partial class MakeUserDataNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoulFoodAiBack.Models.UserFoodPlan", b =>
                {
                    b.Property<int>("IdUserFoodPlan")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserFoodPlans");
                });

            modelBuilder.Entity("SoulFoodAiBack.Models.UserFoodPlanMeal", b =>
                {
                    b.Property<int>("IdFoodPlanMeal")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("UserFoodPlanIdUserFoodPlan")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserFoodPlanIdUserFoodPlan");

                    b.ToTable("UserFoodPlanMeals");
                });
            ...
            modelBuilder.Entity("SoulFoodAiBack.Models.UserDiary", b =>
                {
                    b.HasOne("SoulFoodAiBack.Models.UserFoodPlan", "UserFoodPlan")
                        .WithMany()
            ...
            modelBuilder.Entity("SoulFoodAiBack.Models.UserFoodPlanMeal", b =>
                {
                    ...
                    b.HasOne("SoulFoodAiBack.Models.UserFoodPlan", null)
                        .WithMany("UserFoodPlanMeals")
                        .HasForeignKey("UserFoodPlanIdUserFoodPlan");
