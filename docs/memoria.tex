...
\newcommand{\nombre}{Pablo Velasco Martín} %%% cambio de comando

% Datos de portada
\title{SoulFoodAI Sistema de Gestión Nutricional con Integración de Modelos de Lenguaje de Gran Escala (LLM) para la Generación y Evaluación de Dietas Personalizadas.}
\author{\nombre}
\tutor{Sandra Rodríguez Arribas}
\date{\today}
